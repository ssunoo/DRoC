...
from ortools.constraint_solver import pywrapcp
    ...
    time_horizon = duration_limit + vehicle_load_time + vehicle_unload_time
    routing.SetGlobalSpanCostCoefficient(100)
    time = "Time"
    routing.AddDimension(
        transit_callback_index, time_horizon, time_horizon, False, time
    )
    ...
    # Add load and unload time at the depot
    time_dimension.SetSpanCostCoefficientForAllVehicles(100)
    time_dimension.SetLoadAndUnloadTime(vehicle_load_time, vehicle_unload_time)
