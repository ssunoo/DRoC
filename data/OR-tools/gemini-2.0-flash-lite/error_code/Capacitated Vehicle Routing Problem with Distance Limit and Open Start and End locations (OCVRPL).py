...
def solve(
    ...
    """Solves the VRP with distance and capacity constraints.
    ...
    manager = pywrapcp.RoutingIndexManager(
        len(distance_matrix),
        num_vehicle,
        0,  # Define a dummy start node, since we have open routes
        0,  # Define a dummy end node, since we have open routes
    )
