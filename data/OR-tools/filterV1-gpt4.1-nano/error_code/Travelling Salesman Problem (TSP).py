...
def solve(distance_matrix: list, depot: int):
    ...
    if solution:
        ...
        obj = routing.CostOfVehicle(solution, 0)  # This line causes the error
    else:
        obj = -1
    return obj
